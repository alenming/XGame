...
{
    RippleSprite *pSprite = new RippleSprite();
...
bool RippleSprite::initWithFile(const char* filename)
{
    ...
    do {
       ...
       screenSize = ccp(m_texture->getContentSize().width / scaleRTT,
		...
		listener->onTouchBegan = CC_CALLBACK_2(RippleSprite::ccTouchBegan, this);
		listener->onTouchMoved = CC_CALLBACK_2(RippleSprite::ccTouchMoved, this);
		listener->onTouchEnded = CC_CALLBACK_2(RippleSprite::ccTouchEnded, this);
		listener->onTouchCancelled = CC_CALLBACK_2(RippleSprite::ccTouchCancelled, this);
...
void RippleSprite::addRipple(CCPoint pos, RIPPLE_TYPE type, float strength)
{
...
void RippleSprite::addRippleChild(rippleData* parent, RIPPLE_CHILD type)
{
    rippleData* newRipple;
    CCPoint pos;
...
CCTexture2D* RippleSprite::spriteTexture()
{
    return m_texture;
}
...
bool RippleSprite::isPointInsideSprite(cocos2d::CCPoint pos)
{
...
bool RippleSprite::isTouchInsideSprite(cocos2d::CCTouch *pTouch)
{
    CCPoint pos;
...
bool RippleSprite::ccTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
...
void RippleSprite::ccTouchMoved(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    CCPoint pos;
    pos = pTouch->getLocationInView();
    pos = CCDirector::sharedDirector()->convertToGL(pos);
...
void RippleSprite::ccTouchCancelled(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    //no-op
}


void RippleSprite::ccTouchEnded(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
   //no-op
}


void RippleSprite::onEnterTransitionDidFinish()
{
