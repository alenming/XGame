#ifndef LocalTimer_h__
#define LocalTimer_h__
...
public:
	...
	int getEndTimeStamp(){ return mTimerStamp; };
...
private:
	...
	//小时监听器
	vector<HourListener*> mVectorHourListener;

	//时间戳监听器
	vector<TimeStampListener*> mVectorTimeStampListener;

	//本地倒计时监听器
	vector<TimeLocalListener*> mVectorLocalTimeListener;
